                ...
                <div class="order-card-header">
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <span class="order-date-text">
                            ...
                            <small class="text-muted ms-1">({{ $request->created_at->diffForHumans() }})</small>
                        </span>
                    </div>
                ...
                <div class="order-card-body">
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-12 col-md">
                            @if($request->animal)
                                <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
                                    ...
                                    @if($request->animal->gender)
                                        <span class="badge-sub-tag">
                                            {{ $request->animal->gender === 'male' ? 'Erkak ♂' : 'Urg\'ochi ♀' }}
                                        </span>
                                    @endif
                        ...
                        <div class="col-12 col-md-auto text-md-end">
                            <div class="order-price-label">Narxi</div>
                            @if($request->animal)
